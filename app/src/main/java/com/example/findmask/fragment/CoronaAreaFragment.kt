...
class CoronaAreaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.deleteAll.setOnClickListener {
            Log.i("viewmodelnull", "" + coronaAreaViewModel.getAllAreas().value)
                if (coronaAreaViewModel.getAllAreas().value!!.isEmpty()) {
                } else {
                ...
                CoronaService.getCoronaInfoNew(Utils.API_KEY)
                    .enqueue(object : Callback<CoronaInfoNew> {
                        ...
                        override fun onResponse(
                            ...
                            Log.i("coronaarea", "" + coronaAreaList + "\n" + it)
                            coronaAreaList.clear()
                            lateinit var coronaArea: CoronaArea
                            for (i in it.indices) {
                                Log.i("itindices", "" + it.indices + "\n" + it[i].areaName)
                                if (it[i].areaName.equals(response.body()!!.seoul.countryName)) {
                                    coronaArea = CoronaArea(
                                        response.body()!!.seoul.countryName,
                                        response.body()!!.seoul.newCase,
